 ...
 */
public class FormPNilaiSiswa2 extends javax.swing.JPanel {
private Connection conn = new koneksi().connect();
private DefaultTableModel tabmode;
    /**
     * Creates new form FormPNilaiSiswa
     */
    public FormPNilaiSiswa2() {
        initComponents();
        datatable();
         tampil_comboguru();
         tampil_combomapel();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, -1, 25));
        ...
        jPanel2.add(cbmapel, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 144, 25));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 156, 44, 25));
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 134, 25));
        ...
        jPanel2.add(cbguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 390, 144, 25));
        ...
        jPanel2.add(binput, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 108, 25));
        ...
        bubah.setText("UBAH");
        bubah.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(255, 255, 255)));
        bubah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bubahActionPerformed(evt);
            }
        });
        jPanel2.add(bubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, 108, 25));
        ...
        jPanel2.add(bhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 430, 108, 25));

        tu.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jPanel2.add(tu, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 41, 25));

        ut.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jPanel2.add(ut, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 41, 25));

        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("TUGAS");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 48, 30));

        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("UTS");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 46, 30));

        us.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jPanel2.add(us, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 41, 25));

        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("UAS");
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 46, 30));
        ...
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 230, 91, 25));

        jLabel17.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("HASIL");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 48, 30));

        ni.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ni.setEnabled(false);
        jPanel2.add(ni, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 270, 41, 25));

        jLabel18.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("GRADE");
        jPanel2.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 310, 48, 30));

        gr.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        gr.setEnabled(false);
        jPanel2.add(gr, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 310, 41, 25));
        ...
        jPanel2.add(csem, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 100, 30));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(ctbl, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        // TODO add your handling code here:
          try {
            ...
            String sql = "update t_nilai_siswa set id_nilai_siswa=?,semester=?, nilai_tugas =?,nilai_uts=?,nilai_uas=?,hasil =?,grade = ?,nama_guru = ?, nama_siswa = ?, NIS=?, nama_kelas=?, nama_mapel=? where id_nilai_siswa='"+tidnilaisiswa.getText()+"'";
            PreparedStatement stat = conn.prepareStatement(sql);

            stat.setString(1, tidnilaisiswa.getText());
            stat.setString(2,csem.getSelectedItem().toString());
            stat.setString(3, tu.getText());
            stat.setString(4, ut.getText());
            stat.setString(5, us.getText());
            stat.setString(6, ni.getText());
            stat.setString(7, gr.getText());
            stat.setString(8, cbguru.getSelectedItem().toString());
            stat.setString(9, txtnamasiswa.getText());
            stat.setString(10, tcarisiswa.getText());
            stat.setString(11, txtkelas.getText());
            stat.setString(12, cbmapel.getSelectedItem().toString());
